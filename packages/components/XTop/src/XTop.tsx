...
import style from "../style/XTop.module.styl";
            ...
            if (props.listenElement) {
                scrollDom.addEventListener(
                    ...
                    () => {
                        ...
                        visible.value =
                            domElement.scrollTop >= props.visibilityHeight;
                    },
                    false
                );
            }
                ...
                {this.$slots.default ? (
                    ...
                    <div class={style.default}>
                        ...
                        >
                            ...
                            ></path>
                            <path
                                d="M263.645867 496.7424A34.133333 34.133333 0 0 1 294.161067 477.866667h435.677866a34.133333 34.133333 0 0 1 30.5152 18.875733l111.854934 223.675733A68.266667 68.266667 0 0 1 811.1104 819.2H212.8896a68.266667 68.266667 0 0 1-61.064533-98.781867l111.854933-223.675733zM204.8 887.466667a34.133333 34.133333 0 1 1 68.266667 0v34.133333a34.133333 34.133333 0 1 1-68.266667 0v-34.133333z m580.266667-34.133334a34.133333 34.133333 0 0 0-34.133334 34.133334v34.133333a34.133333 34.133333 0 1 0 68.266667 0v-34.133333a34.133333 34.133333 0 0 0-34.133333-34.133334z"
                                fill={this.$props.color || "#FFAA44"}
                            ></path>
                            <path
                                d="M273.066667 430.08a341.333333 341.333333 0 0 1 119.1936-259.1744l97.518933-83.626667a34.133333 34.133333 0 0 1 44.4416 0l97.518933 83.626667A341.333333 341.333333 0 0 1 750.933333 430.045867V716.8a238.933333 238.933333 0 1 1-477.866666 0v-286.72z"
                                fill={this.$props.color || "#FF7744"}
                                data-spm-anchor-id="a313x.7781069.0.i5"
                            ></path>
                            <path
                                d="M477.866667 819.2a34.133333 34.133333 0 1 1 68.266666 0v136.533333a34.133333 34.133333 0 1 1-68.266666 0v-136.533333z"
                                fill={this.$props.color || "#FFAA44"}
                            ></path>
                            <path
                                d="M512 273.066667a102.4 102.4 0 1 1 0 204.8 102.4 102.4 0 0 1 0-204.8z"
                                fill="#FFFFFF"
                            ></path>
                        </svg>
                    </div>
